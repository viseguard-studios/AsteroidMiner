...
@STest
public class CraftRobotTest extends Test {
    ...
    public void Setup(Scanner sc) {
        ...
        System.out.println("Does your SpaceShip have enough resources to build the robot? (Y/N)");
         ...
         */
            ...
            System.out.println("Does the SpaceShip + Asteroid have enough resources to build the robot? (Y/N)");
            answer = sc.nextLine();
            if(answer.equals("Y")) {
                for (Item i : recipe.getInput())
